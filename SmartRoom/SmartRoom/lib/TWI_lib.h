...
enum TWI_Status_t TWI_PacketTransmit(uint8_t SLA, uint8_t SubAddress, uint8_t *Packet, uint8_t Length);
enum TWI_Status_t TWI_PacketReceive(uint8_t SLA, uint8_t SubAddress, uint8_t *Packet, uint8_t Length);
